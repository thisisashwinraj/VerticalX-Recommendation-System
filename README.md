...
The project was developed in March 2022 as a standalone project & has been licensed under the [GNU Affero General Public License v3.0](https://github.com/ashwinraj-in/VerticalX-Recommendation-System/blob/main/LICENSE). All pull requests are maintained by Ashwin. Learn about VerticalX Recommendations System [here](https://github.com/ashwinraj-in/VerticalX-Recommendation-System#user-installation-and-source-code)
